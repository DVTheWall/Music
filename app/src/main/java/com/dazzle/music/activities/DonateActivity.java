...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "dazzle.music.donate_1";
    private static final String DONATION_2 = "dazzle.music.donate_2";
    private static final String DONATION_3 = "dazzle.music.donate_3";
    private static final String DONATION_5 = "dazzle.music.donate_5";
    private static final String DONATION_10 = "dazzle.music.donate_10";
    private static final String DONATION_20 = "dazzle.music.donate_20";
