...
import com.dazzle.music.helpers.MediaButtonIntentReceiver;
import com.dazzle.music.helpers.MusicPlaybackTrack;
import com.dazzle.music.lastfmapi.LastFmClient;
import com.dazzle.music.lastfmapi.models.LastfmUserSession;
import com.dazzle.music.lastfmapi.models.ScrobbleQuery;
import com.dazzle.music.permissions.Nammu;
import com.dazzle.music.provider.MusicPlaybackState;
import com.dazzle.music.provider.RecentStore;
import com.dazzle.music.provider.SongPlayCount;
...
import com.dazzle.music.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.dazzle.music.playstatechanged";
    public static final String POSITION_CHANGED = "com.dazzle.music.positionchanged";
    public static final String META_CHANGED = "com.dazzle.music.metachanged";
    public static final String QUEUE_CHANGED = "com.dazzle.music.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.dazzle.music.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.dazzle.music.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.dazzle.music.shufflemodechanged";
    public static final String TRACK_ERROR = "com.dazzle.music.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.dazzle.music";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.dazzle.music.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.dazzle.music.togglepause";
    public static final String PAUSE_ACTION = "com.dazzle.music.pause";
    public static final String STOP_ACTION = "com.dazzle.music.stop";
    public static final String PREVIOUS_ACTION = "com.dazzle.music.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.dazzle.music.previous.force";
    public static final String NEXT_ACTION = "fcom.dazzle.music.next";
    public static final String REPEAT_ACTION = "com.dazzle.music.repeat";
    public static final String SHUFFLE_ACTION = "com.dazzle.music.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.dazzle.music.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.dazzle.music.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.dazzle.music.shutdown";
    ...
    private Notification buildNotification() {
        ...
        if (artwork == null) {
            // Dhaval 1 Feb  ic_launcher_logo
            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_launcher_logo);
        }

        if (mNotificationPostTime == 0) {
            mNotificationPostTime = System.currentTimeMillis();
        }
// Dhaval change icon notification
