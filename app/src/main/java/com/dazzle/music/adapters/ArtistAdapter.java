...
import com.dazzle.music.widgets.BubbleTextGetter;
...
//                                            if (isGrid ) {
                                            ...
                                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                              ...
                                              /*      if (swatch != null) {
                                                    ...
                                                    textColor = Color.parseColor("#000000");//#ffffff
                                    ...
                                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                        if (isGrid) {
                                            //      int color = failReason.getVibrantColor(Color.parseColor("#66000000"));
...
//                                            itemHolder.footer.setBackgroundColor(0);
                                            ...
                                            if (mContext != null) {
                                                ...
                                                itemHolder.albums.setTextColor(Color.parseColor("#000000"));
                                            }
                                        }
                                    }
                                });
