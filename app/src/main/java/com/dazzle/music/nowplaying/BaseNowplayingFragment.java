...
package com.dazzle.music.nowplaying;
...
import com.dazzle.music.MusicService;
import com.dazzle.music.R;
import com.dazzle.music.activities.BaseActivity;
import com.dazzle.music.adapters.BaseQueueAdapter;
import com.dazzle.music.adapters.SlidingQueueAdapter;
import com.dazzle.music.dataloaders.QueueLoader;
import com.dazzle.music.listeners.MusicStateListener;
import com.dazzle.music.timely.TimelyView;
...
import com.dazzle.music.utils.SlideTrackSwitcher;
import com.dazzle.music.utils.TimberUtils;
import com.dazzle.music.widgets.CircularSeekBar;
import com.dazzle.music.widgets.DividerItemDecoration;
import com.dazzle.music.widgets.PlayPauseButton;
import com.dazzle.music.widgets.PlayPauseDrawable;
            ...
            if (albumart != null) {
                ...
                ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                        new DisplayImageOptions.Builder().cacheInMemory(true)
                                .showImageOnFail(R.drawable.ic_launcher_logo)
                            ...
                            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                // Dhaval 1 Feb  ic_launcher_logo
                                Bitmap failedBitmap = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_launcher_logo);
