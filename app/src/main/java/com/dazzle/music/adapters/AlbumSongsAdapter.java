...
*/
        ...
        itemHolder.main_imag.setImageResource(R.drawable.ic_launcher_logo);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        protected ImageView menu, main_imag;

        public ItemHolder(View view) {
            super(view);
            this.title = (TextView) view.findViewById(R.id.song_title);
            this.duration = (TextView) view.findViewById(R.id.song_duration);
            this.main_imag = (ImageView) view.findViewById(R.id.main_imag);
