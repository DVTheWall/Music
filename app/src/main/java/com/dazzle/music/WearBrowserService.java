...
import com.dazzle.music.dataloaders.AlbumLoader;
import com.dazzle.music.dataloaders.AlbumSongLoader;
import com.dazzle.music.dataloaders.ArtistAlbumLoader;
import com.dazzle.music.dataloaders.ArtistLoader;
import com.dazzle.music.dataloaders.ArtistSongLoader;
import com.dazzle.music.dataloaders.PlaylistLoader;
import com.dazzle.music.dataloaders.PlaylistSongLoader;
import com.dazzle.music.dataloaders.SongLoader;
import com.dazzle.music.models.Album;
import com.dazzle.music.models.Artist;
import com.dazzle.music.models.Playlist;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "dazzle.music/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "dazzle.music/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "dazzle.music/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "dazzle.music/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
